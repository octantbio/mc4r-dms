---
title: MC4R Gs Forskolin Offsets
format: gfm
code-fold: true
jupyter:
  kernelspec:
...
These plots compare the original MC4R Gs summary statistics located [here](../MC4R-DMS5-Gs-unnormalized.tsv) with the version incorporating forskolin barcode-level offsets located [here](mc4r-cre-cleaned.sumstats.tsv). In general, stop effects and global variant effect patters are stronger when incorporating the barcode forskolin offset.

...
### Library Dosing
    ...
    ## ec50_drugaMSH      -9.99      0.09   -10.19    -9.82 1.00     3425     2228
    ## ec50_drugTHIQ      -8.03      0.10    -8.20    -7.82 1.00     2574     2553
    ## emax_Intercept      3.35      0.06     3.23     3.47 1.00     2739     2424
    ## slope_Intercept     1.10      0.18     0.79     1.50 1.00     2511     2504
    ## 
    ## Family Specific Parameters: 
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.34      0.03     0.29     0.39 1.00     3561     2816
    ## 
...
Same thing for Gq
    ...
    ## Population-Level Effects: 
    ##                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## ec50_drugaMSH      -7.57      0.13    -7.81    -7.28 1.00     1104     1462
    ## ec50_drugTHIQ      -5.86      0.15    -6.15    -5.56 1.00     1331     1733
    ## emax_Intercept      2.92      0.09     2.75     3.12 1.00     1138     1327
    ## slope_Intercept     0.51      0.05     0.43     0.61 1.00     1307     1754
    ## 
    ## Family Specific Parameters: 
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.16      0.01     0.14     0.18 1.00     2190     2372
    ## 
    ## Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
    ## and Tail_ESS are effective sample size measures, and Rhat is the potential
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
